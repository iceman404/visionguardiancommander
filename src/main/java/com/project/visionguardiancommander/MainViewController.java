...
public class MainViewController {
    ...
    void startAdminPanel(ActionEvent event) throws Exception {
        FXMLLoader adminLoader = new FXMLLoader(MainApplication.class.getResource("admin-view.fxml"));
    ...
    void displayFacesRecord() {
        ...
        if (directory.exists() && directory.isDirectory()) {
            ...
            if (files != null && files.length > 0) {
                ...
                try {
                    Address[] toAddresses = InternetAddress.parse("johnsubba404@gmail.com");
