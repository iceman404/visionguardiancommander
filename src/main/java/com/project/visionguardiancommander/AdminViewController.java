...
public class AdminViewController {
    ...
    @FXML
    private Label deleteScreenStatusLabel;
    ...
    public void showSearchResultDelete() {
        ...
        if(searchDelete.getActiveStatus()==null) {
            ...
            // Apply the larger font to the label
            //displayPhotoLabel.setFont(largerFont);
            deleteScreenPhotoLabel.setText("NA");
            deleteScreenLabelName.setText(" "+" "+ " ");
            deleteScreenLabelRegistrationNo.setText(" ");
            deleteScreenLabelAgeInfo.setText(" ");
    ...
    void deleteConfirm(ActionEvent event) {
        ...
        Font largerFont = Font.font(deleteScreenStatusLabel.getFont().getFamily(), FontWeight.BOLD, 18); // You can adjust the size (16 in this example)
        if(tempQuery.getActiveStatus() == null) {
            deleteScreenStatusLabel.setText("Nothing Deleted!");
        ...
        deleteScreenStatusLabel.setFont(largerFont);
        if(tempQuery.getActiveStatus() == true || tempQuery.getSpecialCode().equalsIgnoreCase(deleteUniqueCode)) {
            ...
            deleteScreenStatusLabel.setText("Deleted!");
        }
