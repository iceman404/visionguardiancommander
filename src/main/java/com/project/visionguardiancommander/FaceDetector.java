...
public class FaceDetector implements Runnable {
    ...
    public void init() {
        ...
        setClassifier("/haar_cascade/haarcascade_frontalface_alt.xml");
        setClassifierEye("/haar_cascade/haarcascade_eye.xml");
        setClassifierEyeGlass("/haar_cascade/haarcascade_eye_tree_eyeglasses.xml");
        setClassifierSideFace("/haar_cascade/haarcascade_profileface.xml");
        setClassifierFullBody("/haar_cascade/haarcascade_fullbody.xml");
        setClassifierUpperBody("/haar_cascade/haarcascade_upperbody.xml");
        setClassifierSmile("/haar_cascade/haarcascade_smile.xml");
